...
public class Guards {
  // NOSONAR I know this code looks just liek ... but they are just accidentally ...
  public static final int DEAD_PAY_AMOUNT = 1;

  public int getPayAmount(Marine marine, BonusPackage bonusPackage) {
    if (marine == null || (bonusPackage.value() < 10 || bonusPackage.value() > 100)) { // guards
    ...
    return computePayAmount(marine, bonusPackage);
  }

  private int computePayAmount(Marine marine, BonusPackage bonusPackage) {
