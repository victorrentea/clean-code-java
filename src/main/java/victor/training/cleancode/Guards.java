...
public class Guards {
  ...
  public int getPayAmount(Marine marine, BonusPackage bonusPackage) {
    ...
    if (isDead(marine)) { // guard condition / early return/throw
    ...
    int result = doComputePay(marine, bonusPackage);
    // HEAVY core logic here, business-rules ...
    return result;
  }

  private int doComputePay(Marine marine, BonusPackage bonusPackage) {
