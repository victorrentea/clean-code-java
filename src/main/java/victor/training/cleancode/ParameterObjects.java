...
class PersonService {
   ...
   public void p(StreetAddress streetAddress) {
      System.out.println("Living in " + streetAddress.getCity() + " on St. " + streetAddress.getStreetName() + " " + streetAddress.getStreetNumber());
   }

   public void pcaller() {
       p(new StreetAddress("Bucharest", "Dristor", 91));
   }
}