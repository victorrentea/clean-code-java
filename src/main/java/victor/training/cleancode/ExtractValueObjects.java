...
class Interval {
   ...
   public boolean intersects(Interval other) {
      return start <= other.end && other.start <= end; // isafely copy pasted it from SO
   }
   ...
   public Interval extendEnd(int delta) {
      return new Interval(start, end + delta);
   }
}
