...
public class GuardClauses {
  ...
  private int doComputePayroll(Marine marine, BonusPackage bonusPackage) {
    if (isDead(marine)) { // guard conditions that protect the reader from trivial/dengenerate cases.
