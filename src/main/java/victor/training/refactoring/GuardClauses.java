...
//      @Var
//      Marine marine2 = marine.withRetired(false);

//      return marine2.withRetired(false)
//          .withX()
//          .withY();

//      return marine2.withRetiredXY(RetiredXY.of());
      ...
      return doTheRealComputation(marine);
   }

   private int doTheRealComputation(Marine marine) {
