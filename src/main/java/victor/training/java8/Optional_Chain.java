...
//      if (
//          parcel!=null &&
//          parcel.getDelivery()!=null && // OK
//          parcel.getDelivery().getAddress()!=null && // degeaba = PANICA
//          parcel.getDelivery().getAddress().getContactPerson()!=null && // OK
//          parcel.getDelivery().getAddress().getContactPerson().getName()!=null // degeaba
//
//      )
