...
//
		...
		//switch (monthlyPaymentType().paymentTypeId){
			//case 1:
				//warrantyData["paymentType"] = "Einmalzahlung";
			//break;
			//case 2:
				//warrantyData["paymentType"] = "Monatliche Zahlweise";
			//break;
			//case 3:
			//warrantyData["paymentType"] = "Quartal Zahlweise";
			//break;
			//default:
				//warrantyData["paymentType"] = "Einmalzahlung";
		//}
