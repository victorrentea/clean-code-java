//package com.realgarant.wms.business.contract.offer.maintenance.usecases;
//
//import com.realgarant.wms.business.CurrentUser;
//import com.realgarant.wms.business.common.amendment.Amendment;
//import com.realgarant.wms.business.contract.maintenance.MaintenancePlanStore;
//import com.realgarant.wms.business.contract.maintenance.usecases.*;
//import com.realgarant.wms.business.contract.offer.maintenance.MaintenanceContractOffer;
//import com.realgarant.wms.business.contract.offer.maintenance.MaintenanceContractOffers;
//import com.realgarant.wms.business.contract.offer.maintenance.MaintenanceContractOfferStore;
//import com.realgarant.wms.business.partner.Partner;
//import com.realgarant.wms.business.partner.usecases.GetPartner;
//import com.realgarant.wms.business.warrantyprogram.WarrantyProgram;
//import com.realgarant.wms.business.warrantyprogram.usecases.GetWarrantyProgram;
...
//
//    @Inject GetWarrantyProgram getWarrantyProgram;
//    @Inject MaintenanceContractOfferStore store;
//    @Inject MaintenanceContractOffers offers;
//    @Inject GetPartner getPartner;
...
//    }
//
//    private MaintenanceContractOffer init(GetMaintenancePlanRequest maintenancePlanRequest, GetMaintenancePlanResponse maintenancePlanResponse, WarrantyProgram warrantyProgram, Partner partner) {
