...
class ExtractValueObjectsTest {
   ...
   CarModel fordFocusMk2 = new CarModel("Ford", "Focus", new Range(2012, 2016));
   ...
   void byYear_match() {
      ...
      List<CarModel> models = searchEngine.filterCarModels(List.of(fordFocusMk2), new Range(criteria.getStartYear(), criteria.getEndYear()));
