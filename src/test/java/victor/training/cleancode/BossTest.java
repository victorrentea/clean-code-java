...
class BossTest {
   ...
   void bossLevelFluff(OutputCapture outputCapture) {
      target.bossLevelBulgaria(ImmutableList.of(new Task(5)), false);
   ...
   void bossLevelFluff_c323(OutputCapture outputCapture) {
      target.bossLevelBulgaria(ImmutableList.of(new Task(5)), true);
   ...
   void bossLevelFluff_emptyList(OutputCapture outputCapture) {
      target.bossLevelBulgaria(ImmutableList.of(), false);
   ...
   void stuffForEachElement_inWateverOrder(OutputCapture outputCapture) {
      target.bossLevelBulgaria(ImmutableList.of(new Task(5),new Task(6)), false);
